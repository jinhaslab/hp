...
class CreatePostView(PermissionRequiredMixin, CreateView):
    ...
    permission_required = ('presentation.add_post',)
...
class PostDetail(generic.DetailView):
    model = Post
    template_name = 'presentation/post_detail.html'
...
class SearchResultsView(generic.ListView):
    model = Post
    template_name = 'presentation/search_results.html'
...
class PostUpdateView(PermissionRequiredMixin, UpdateView):
    ...
    template_name = 'presentation/edit_post.html'
    success_url = reverse_lazy('presentation:home')
    permission_required = 'presentation.change_post'
...
class PostDeleteView(PermissionRequiredMixin, DeleteView):
    model = Post
    template_name = 'presentation/delete_post.html'
    # Define where to redirect after the post is successfully deleted
    success_url = reverse_lazy('presentation:home')
    permission_required = 'presentation.delete_post'
