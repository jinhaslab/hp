...
class PostList(generic.ListView):
    model = Post
    template_name = 'aiapps/index.html'
...
class CreatePostView(PermissionRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy('aiapps:home')
    permission_required = ('aiapps.add_post',)
...
class PostDetail(generic.DetailView):
    model = Post
    template_name = 'aiapps/post_detail.html'
...
class SearchResultsView(generic.ListView):
    model = Post
    template_name = 'aiapps/search_results.html'
...
class PostUpdateView(PermissionRequiredMixin, UpdateView):
    ...
    template_name = 'aiapps/edit_post.html'
    success_url = reverse_lazy('aiapps:home')
    permission_required = 'aiapps.change_post'
...
class PostDeleteView(PermissionRequiredMixin, DeleteView):
    model = Post
    template_name = 'aiapps/delete_post.html'
    # Define where to redirect after the post is successfully deleted
    success_url = reverse_lazy('aiapps:home')
    permission_required = 'aiapps.delete_post'
...
def custom_permission_denied_view(request, exception):
    ...
    return render(request, 'aiapps/403.html', context, status=403)